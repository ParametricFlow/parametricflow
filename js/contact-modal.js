        ...
        <div class="modal-overlay" id="contact-modal" aria-hidden="true">
            <div class="modal-box" role="dialog" aria-modal="true" aria-labelledby="contact-modal-title" style="background:#0b1b36; max-width:508px; width:100%; border-radius:20px; padding:40px 36px; box-sizing:border-box;">
                ...
                <form id="contact-form">
                    ...
                    <div class="form-row" id="contact-name-email-row">
                        <div class="field" style="margin-bottom:20px;">
                            ...
                            <input type="text" id="modal-name" name="name" required style="width:100%; box-sizing:border-box; background:#0f2545; border:1px solid #2196f3; border-radius:6px; color:#ffffff; padding:12px 14px;">
                        </div>
                        <div class="field" style="margin-bottom:20px;">
                            <label for="modal-email" style="display:block; color:#a8bcd6; text-transform:uppercase; letter-spacing:0.5px; font-size:13px; font-weight:600; margin-bottom:8px;">Correo</label>
                            <input type="email" id="modal-email" name="email" required style="width:100%; box-sizing:border-box; background:#0f2545; border:1px solid #1c3a63; border-radius:6px; color:#ffffff; padding:12px 14px;">
                        </div>
                    </div>

                    <style id="contact-modal-mobile-style">
